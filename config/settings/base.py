...
if ENABLE_LDAP:
    ...
    if ENABLE_LDAP_SECONDARY:
        ...
        if AUTH_LDAP2_CA_CERT_FILE is not None:
            AUTH_LDAP_CONNECTION_OPTIONS[ldap.OPT_X_TLS_CACERTFILE] = AUTH_LDAP2_CA_CERT_FILE
        AUTH_LDAP_2USER_FILTER = env.str('AUTH_LDAP2_USER_FILTER', '(sAMAccountName=%(user)s)')

        AUTH_LDAP2_USER_SEARCH = LDAPSearch(
            env.str('AUTH_LDAP2_USER_SEARCH_BASE', None),
            ldap.SCOPE_SUBTREE,
            AUTH_LDAP_2USER_FILTER,
        )
